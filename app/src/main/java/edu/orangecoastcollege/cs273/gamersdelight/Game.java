...
public class Game implements Parcelable{
    ...
    /**
     * Return 0 if its a standard parcel, else if sending files need to return file
     * descriptors.
     * @return 0
     */
    @Override
    ...
    /**
     * writes all of the member variables of the class to a parcel. We specify data type.
